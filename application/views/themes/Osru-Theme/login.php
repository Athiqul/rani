        ...
        <div class="custom-container">
            <div class="bg-white rounded-xl flex flex-col lg:flex-row lg:justify-between lg:items-center"> 
                <div class="lg:w-[60%] hidden lg:block">
                    <img src="<?php echo $ascurl;?>/uploads/2023-11-19T172113Z_983293843_UP1EJBJ1C7AXN_RTRMADP_3_CRICKET-WORLDCUP-IND-AUS-1703363199.webp" alt="Cricket match img">
                </div>
                   ...
                   <form> 
                    <div class="mt-5 lg:mt-10">
                        <div>
                            ...
                            <div>
                              <input name="email" type="text" placeholder="Enter your email" required="" class="relative w-full h-12 p-4 py-1 border border-[#D8DCE3] focus:border-gray/30 outline-none placeholder:text-[#6A737D] text-[#6A737D] text-sm">
                            </div>
                        </div>
                        ...
                        <div class="mt-4 mb-7">
                            ...
                            <div>
                              <input name="password" type="password" placeholder="Password" required="" class="relative w-full h-12 p-4 py-1 border border-[#D8DCE3] focus:border-gray/30 outline-none placeholder:text-[#6A737D] text-[#6A737D] text-sm">
                            </div>
                        </div>
                    ...
                    <div class="mt-5 lg:mt-10 text-sm text-black">
                        ...
                        <span class="font-semibold">
                            <a class="hover:text-blue-600" href="<?php echo base_url('registration')?>">Sign up</a>
                        </span>
                    </div>
                </div> 
            </div>
